...
### Added
- Firefox extension now includes the same icons (16×16, 32×32, 48×48, 128×128) as the Chrome extension, enabling proper browser toolbar and extension-manager display
